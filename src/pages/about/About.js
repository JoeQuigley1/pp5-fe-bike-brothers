    ...
    <Container className={styles.Content}>
      <Row>
        <Col>
          ...
          <br />
          <p>
            This site is for Bike Enthusiasts who want to share bike related
            content.
          </p>
          <br />
          <p>
            Please feel free to post content, create a meetup, like and share
            anything bike related.
          </p>
          <br />
          <p>
            Our meetups encourge bike Enthusiasts to gather together and show
            off their bikes in real life!
          </p>
        </Col>
      </Row>
      <Row>
